...
import masyForm from './components/masyForm.vue';
import masyFormItem from './components/masyFormItem.vue';
...
Vue.component(masyForm.name, masyForm);
Vue.component(masyFormItem.name, masyFormItem);
